...
def main():
    ap = argparse.ArgumentParser(description='Fetch Salesforce help docs page.')
    ...
    urls = cfg['sources']['help_docs']['urls'][: args.limit]
    ...
    for url in urls:
        ...
        did = doc_id('help_docs', date_iso, slug, b)
        raw_dir = os.path.join('data', 'raw', 'help_docs')
        ...
        if args.dry_run:
            ...
            saved += 1
    logger.info(f"Saved {saved} help docs pages. Log: {log_path}")
